(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["quillEasyTable"] = factory(require("quill"));
	else
		root["quillEasyTable"] = factory(root["Quill"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE__0__) {
return /******/ (function(modules) { // webpackBootstrap
/******/ 	function hotDisposeChunk(chunkId) {
/******/ 		delete installedChunks[chunkId];
/******/ 	}
/******/ 	var parentHotUpdateCallback = window["webpackHotUpdatequillEasyTable"];
/******/ 	window["webpackHotUpdatequillEasyTable"] = // eslint-disable-next-line no-unused-vars
...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "f54873537bd031c30b32";
...
class table_TableContainer extends Container {
  ...
  tableDestroy() {
    ...
    const tableModule = quill.getModule("easy-table");
    this.remove();
...
table_TableContainer.className = "quill-easy-table";
...
table_TableViewWrapper.className = "quill-easy-table-wrapper";
...
// CONCATENATED MODULE: ./src/quill-easy-table.js
...
const quill_easy_table_Delta = external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_default.a.import('delta');


class quill_easy_table_EasyTable extends Module {
  static register() {
  ...
  constructor(quill, options) {
    super(quill, options); // handle click on quill-easy-table
    ...
    this.quill.root.addEventListener('click', evt => {
      ...
      const tableNode = path.filter(node => {
        return node.tagName && node.tagName.toUpperCase() === 'TABLE' && node.classList.contains('quill-easy-table');
      })[0];
    ...
    }, false); // handle right click on quill-easy-table
    ...
    quill.keyboard.bindings['Backspace'].splice(0, 1, thisBinding); // add Matchers to match and render quill-easy-table for initialization
    // or pasting
  ...
  insertTable(rows, columns) {
    ...
    let delta = new quill_easy_table_Delta().retain(range.index);
    delta.insert('\n'); // insert table column
...
quill_easy_table_EasyTable.keyboardBindings = {
...
/* harmony default export */ var quill_easy_table = __webpack_exports__["default"] = (quill_easy_table_EasyTable);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var src_quill_easy_table_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10);
/* harmony import */ var src_assets_quill_easy_table_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
/* harmony import */ var src_assets_quill_easy_table_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(src_assets_quill_easy_table_scss__WEBPACK_IMPORTED_MODULE_1__);
 // import easy-table styles file


Quill.register({
  'modules/easy-table': src_quill_easy_table_js__WEBPACK_IMPORTED_MODULE_0__["default"]
}, true);
...
window.onload = () => {
  const quill = new Quill('#editor-wrapper', {
    ...
    modules: {
      ...
      keyboard: {
        bindings: src_quill_easy_table_js__WEBPACK_IMPORTED_MODULE_0__["default"].keyboardBindings
      }
    }
  });
